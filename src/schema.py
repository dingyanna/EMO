...
model_schema = {
    ...
    "knot1": merge(tinteger, default(1)),
    "knot2": merge(tinteger, default(2)),
    "opt_algo": merge(tstring, default('penalty')),
...
curriculum_schema = {
    ...
    "epsilon": merge(tfloat, default(10.)),
} 

multilayer_schema = {
    "K": merge(tinteger, default(10)),
    "z_lr": merge(tfloat, default(0.1)),  
    "z_lb": merge(tfloat, default(0.1)),
    "epsilon": merge(tfloat, default(6.)),
    "rho": merge(tfloat, default(1.))
}
...
training_schema = {
    ...
    "multilayer": stdict(multilayer_schema)
}
