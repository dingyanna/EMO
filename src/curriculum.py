...
class Curriculum:
    def __init__(self, args):
        ...
        self.init_epsilon = args.epsilon
    ...
    def update(self):
        ...
        # remove the scheduling of n_points to avoid compound factor
        self.epsilon = max(5, self.init_epsilon / math.sqrt(self.step_count))
